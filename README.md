...
Se ha preparado un video donde se muestra el funcionamiento del proyecto, la apertura del modelo en **BOUML**, la generación automática de código fuente en C++ y la ejecución de la demostración.

**Enlace al video:**
https://youtu.be/NBJPI346bmQ
